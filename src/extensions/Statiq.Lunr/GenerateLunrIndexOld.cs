...
namespace Statiq.Lunr
{
    ...
    public class GenerateLunrIndexOld : Module
    {
        ...
        /// <param name="stopwordsPath">A file to use that contains a set of stopwords.</param>
        /// <param name="enableStemming">If set to <c>true</c>, stemming is enabled.</param>
        public GenerateLunrIndexOld(string searchIndexItemMetadataKey, in NormalizedPath stopwordsPath = default, bool enableStemming = false)
        ...
        /// <param name="stopwordsPath">A file to use that contains a set of stopwords.</param>
        /// <param name="enableStemming">If set to <c>true</c>, stemming is enabled.</param>
        public GenerateLunrIndexOld(string searchIndexItemMetadataKey, bool useDefaultValues, in NormalizedPath stopwordsPath = default, bool enableStemming = false)
        ...
        /// <param name="stopwordsPath">A file to use that contains a set of stopwords.</param>
        /// <param name="enableStemming">If set to <c>true</c>, stemming is enabled.</param>
        public GenerateLunrIndexOld(Config<ILunrIndexItem> searchIndexItem, in NormalizedPath stopwordsPath = default, bool enableStemming = false)
        {
        ...
        public GenerateLunrIndexOld IncludeHost(bool includeHost = true)
        {
        ...
        /// <param name="stopwordsPath">A file to use that contains a set of stopwords.</param>
        /// <returns>The current module instance.</returns>
        public GenerateLunrIndexOld WithStopwordsPath(in NormalizedPath stopwordsPath)
        {
            _stopwordsPath = stopwordsPath;
            return this;
        }
        ...
        /// <param name="enableStemming">If set to <c>true</c>, stemming is enabled.</param>
        /// <returns>The current module instance.</returns>
        public GenerateLunrIndexOld EnableStemming(bool enableStemming = true)
        {
            _enableStemming = enableStemming;
            return this;
        }
        ...
        /// <returns>The current module instance.</returns>
        public GenerateLunrIndexOld WithDestination(in NormalizedPath destination)
        {
        ...
        /// <returns>The current module instance.</returns>
        public GenerateLunrIndexOld WithScript(Func<StringBuilder, IExecutionContext, string> script)
        {
