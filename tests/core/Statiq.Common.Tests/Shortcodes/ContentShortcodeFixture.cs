...
{
    [TestFixture]
    public class ContentShortcodeFixture : BaseFixture
    {
        ...
        public class TestShortcode : ContentShortcode
        {
            ...
            public override Task<string> ExecuteAsync(KeyValuePair<string, string>[] args, string content, IDocument document, IExecutionContext context) => Task.FromResult(Content);
        }
    }
}
